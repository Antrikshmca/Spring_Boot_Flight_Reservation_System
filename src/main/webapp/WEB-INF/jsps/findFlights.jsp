				...
				<form action="findFlights" class="was-validated" method="post">
					...
					<div class="form-group">
						<label for="from">From:</label> <input type="text"
							class="form-control" id="from" placeholder="Enter source"
							name="from" required>
					...
					<div class="form-group">
						<label for="dep">Departure Date:</label> <input type="date"
							class="form-control" id="dep" placeholder="Enter Departure Date"
